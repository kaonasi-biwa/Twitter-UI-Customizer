...
const TUICData = {
  ...
  visibleButtons: {
    ...
    buttonFunction: {
      ...
      "url-copy": function (e) {
        for(let i = 0; i <= 2 ; i++){
          const urlCopyButton = document.querySelector(`[role="menuitem"] :is([d="M11.96 14.945c-.067 0-.136-.01-.203-.027-1.13-.318-2.097-.986-2.795-1.932-.832-1.125-1.176-2.508-.968-3.893s.942-2.605 2.068-3.438l3.53-2.608c2.322-1.716 5.61-1.224 7.33 1.1.83 1.127 1.175 2.51.967 3.895s-.943 2.605-2.07 3.438l-1.48 1.094c-.333.246-.804.175-1.05-.158-.246-.334-.176-.804.158-1.05l1.48-1.095c.803-.592 1.327-1.463 1.476-2.45.148-.988-.098-1.975-.69-2.778-1.225-1.656-3.572-2.01-5.23-.784l-3.53 2.608c-.802.593-1.326 1.464-1.475 2.45-.15.99.097 1.975.69 2.778.498.675 1.187 1.15 1.992 1.377.4.114.633.528.52.928-.092.33-.394.547-.722.547z"],
      ...
      "userMute":function(article){
        for(let i = 0; i <= 2 ; i++){
          const blockButton = document.querySelector("[role=\"menuitem\"] [d=\"M18 6.59V1.2L8.71 7H5.5C4.12 7 3 8.12 3 9.5v5C3 15.88 4.12 17 5.5 17h2.09l-2.3 2.29 1.42 1.42 15.5-15.5-1.42-1.42L18 6.59zm-8 8V8.55l6-3.75v3.79l-6 6zM5 9.5c0-.28.22-.5.5-.5H8v6H5.5c-.28 0-.5-.22-.5-.5v-5zm6.5 9.24l1.45-1.45L16 19.2V14l2 .02v8.78l-6.5-4.06z\"]");
          if(blockButton == null){
            article.querySelector("[data-testid=\"caret\"]").click();
          }else{
      ...
      "quoteTweet":function(retButton){
        for(let i = 0; i <= 2 ; i++){
          const quoteButton = document.querySelector("[role=\"menuitem\"][href=\"/compose/tweet\"]");
          if(quoteButton == null){
            retButton.click();
          }else{
            quoteButton.click();
