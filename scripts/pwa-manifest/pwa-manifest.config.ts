export const pwaManifest = (description: string, newTweet: string, explore: string, notifications: string, directMessages: string) => ({
    ...
    description: description, //"ニュース速報、政治、音楽トレンド、世界の出来事、スポーツ結果、世界の最新ニュースについての記事を、少ないデータ通信量ですぐに入手できます。",
    display: "standalone",
    ...
    icons: [
        ...
        {
            src: "https://abs.twimg.com/responsive-web/client-web/icon-default-large.8e027b68.png",
            sizes: "512x512",
            type: "image/png",
        },
        {
            purpose: "maskable",
            src: "https://abs.twimg.com/responsive-web/client-web/icon-default-maskable.2fd29c88.png",
            sizes: "192x192",
            type: "image/png",
        },
        {
            purpose: "maskable",
            src: "https://abs.twimg.com/responsive-web/client-web/icon-default-maskable-large.ee2b7aa8.png",
            sizes: "512x512",
            type: "image/png",
        },
    ],
    ...
    shortcuts: [
        ...
        {
            name: directMessages, //"ダイレクトメッセージ",
