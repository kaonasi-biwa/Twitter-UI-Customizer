<template>
    <div>
        ...
        <div>
            <span class="text-white r-1tl8opc wrap-break-word min-w-[0px] css-901oao TUIC_setting_text TUIC_setting_color_select_info">{{ TUICI18N.get("settingColors-select-explain") }} </span>
        </div>
        <br />
