<template>
    <div>
        <SectionHeading title-i18-n="bottomTweetButtons-settingTitle" />
        <FIGURE_TWEETBUTTONS_BOTTOM class="TUIC_setting_TwButtonFigure" />

        <UpDownList id="visibleButtons" />
        <SectionHeadingSecond title-i18-n="bottomTweetButtons-settingTitle" />
        ...
        <div style="margin-top: 20px">
            ...
            <SectionHeadingSecond title-i-18-n="bottomTweetButtons-setting-linkCopy" />
            <RadioButtonList id="tweetDisplaySetting.linkCopyURL" /><br />

            <SectionHeadingSecond style="margin-top: 0" title-i-18-n="bottomTweetButtons-setting-linkShareMenuCopy" />
            <RadioButtonList id="tweetDisplaySetting.linkShareCopyURL" /><br />
        </div>
    </div>
    <hr class="TUIC_setting_divider TUIC_setting_divider_nomargin" />
    <div>
        <SectionHeading title-i18-n="tweetTopButton-settingTitle" />
    ...
    <hr class="TUIC_setting_divider TUIC_setting_divider_nomargin" />
    <div>
        <SectionHeading title-i18-n="tweetMoreMenuItems-settingTitle" />
    ...
    <hr class="TUIC_setting_divider TUIC_setting_divider_nomargin" />
    <div>
        <SectionHeading title-i18-n="fixEngagements-settingTitle" />
    ...
    <hr class="TUIC_setting_divider TUIC_setting_divider_nomargin" />
    <div>
        <SectionHeading style="margin-bottom: 15px" titleI18N="tweetSettings-showMore" />
        <RadioButtonList id="tweetDisplaySetting.showMore" />
    </div>
    <hr class="TUIC_setting_divider TUIC_setting_divider_nomargin" />
    <div>
        <SectionHeading style="margin-bottom: 15px" titleI18N="timeline-discoverMore" />
        <RadioButtonList id="timeline-discoverMore" />
    </div>
    <hr class="TUIC_setting_divider TUIC_setting_divider_nomargin" />
    <div>
        <SectionHeading style="margin-bottom: 15px" titleI18N="composetweet-settingTitle" />
        <SectionHeadingSecond titleI18N="composetweet-toolbar-settingTitle" />
        <UpDownList style="margin-top: 20px" id="postingDialog.toolbar" />
        <SectionHeadingSecond titleI18N="settingSection-other" />
        <CheckBoxList id="composetweet" />
    </div>
    <hr class="TUIC_setting_divider TUIC_setting_divider_nomargin" />
    <div>
        <SectionHeading titleI18N="tweetViewSettings-other" />

        <SectionHeadingSecond titleI18N="bottomTweetButtons-settingTitle-linkCard" />
