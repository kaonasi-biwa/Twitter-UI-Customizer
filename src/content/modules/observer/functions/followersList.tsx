...
const data: {
    [key: string]: { selector: string; clickEvent?: (baseElement: HTMLElement) => void; svg?: string };
} = {
    followButton: {
    ...
    blockButton: {
        selector: `[data-TUICFollowerListButton="blockButton"]`,
    ...
    muteButton: {
        selector: `[data-TUICFollowerListButton="muteButton"]`,
    ...
    reportButton: {
        selector: `[data-TUICFollowerListButton="reportButton"]`,
    ...
    removeFollowerButton: {
        selector: `[data-TUICFollowerListButton="removeFollowerButton"]`,
...
export function followersList() {
    if (location.pathname.endsWith("/followers") && document.querySelectorAll(`[aria-haspopup="menu"]`)) {
        for (const elem of document.querySelectorAll(`[data-testid="primaryColumn"] [data-testid="UserCell"]:not(.${ProcessedClass})`)) {
            elem.process();
            const baseElement = elem.querySelector(data.followButton.selector).hasClosest<HTMLElement>(data.moremenuButton.selector);
