...
const elem = (): JSX.Element => {
    return (
        <a
            ...
            dir="ltr"
            role="link"
            class={`TUICOriginalContent css-1rynq56 min-w-[0px] r-qvutc0 r-1tl8opc font-normal r-hrzydr cursor-pointer ${fontSizeClass(
        ...
        >
            <span class="css-1qaijid min-w-[0px] r-qvutc0 r-1tl8opc" style={{ "text-overflow": "unset" }}>
