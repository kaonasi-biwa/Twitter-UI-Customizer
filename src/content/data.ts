...
<div class="css-175oi2r r-obd0qt r-18u37iz TUICOriginalContent TUICDMIconBox">
                ...
                <div class="css-175oi2r r-1adg3ll r-1pi2tsx r-13qz1uu r-u8s1d r-1wyvozj r-1v2oles r-desppf r-bztko3">
                    <div class="r-1p0dtai r-1pi2tsx r-u8s1d r-1d2f490 r-ipm5af r-13qz1uu">
                        <div class="css-175oi2r r-sdzlij r-1udh08x r-u8s1d r-ggadg3 r-8jfcpp" style="width: calc(100% + 4px); height: calc(100% + 4px);">
                            <a href="${document.querySelector(`[data-testid="DM_Conversation_Avatar"]:not([data-testid="conversation"] *)`)?.href ?? ""}" role="link" class="css-175oi2r r-1pi2tsx r-13qz1uu r-o7ynqc r-6416eg r-1ny4l3l r-1loqt21" style="background-color: rgba(0, 0, 0, 0);">
    ...
    "tweetDisplaySetting.tweetMoreMenuItems": {
        all: ["notHelpful", "notInterested", "follow", "addMemberOfList", "userMute", "muteTalk", "leaveTalk", "block", "engagements", "embed", "report", "hiddenReply"],
        i18n: {
            notHelpful: "tweetTopButton-notHelpful",
            hiddenReply: "tweetTopButton-hiddenReply",
            notInterested: "tweetTopButton-notInterested",
            follow: "tweetTopButton-follow",
            addMemberOfList: "tweetTopButton-addMemberOfList",
            userMute: "bottomTweetButtons-userMute",
            muteTalk: "tweetTopButton-muteTalk",
            leaveTalk: "tweetTopButton-leaveTalk",
            block: "bottomTweetButtons-userBlock",
